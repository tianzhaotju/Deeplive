...
# def test(user_id):
#     # path setting
#     TRAIN_TRACES = './dataset/new_network_trace/'  # train trace path setting,
#     # video_size_file = './video_trace/frame_trace_'      #video trace path setting,
#     video_size_file = './dataset/video_trace/video_trace/AsianCup_China_Uzbekistan/frame_trace_'  # video trace path setting,
...
#             bit_rate, target_buffer = abr.run(S_time_interval, S_send_data_size, S_frame_time_len, S_frame_type,S_real_quality, S_buffer_size, S_end_delay,S_rebuf,rebuf_time, cdn_has_frame, cdn_flag, buffer_flag)
