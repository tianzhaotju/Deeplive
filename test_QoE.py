...
def test(user_id,abr_name,qoe,network):
    ...
    model_name = "./"+ABR_NAME+"_models/"+QoE+"/"
    ...
    while True:
        ...
        if end_of_video:
            ...
            # w.writerow([trace_count,reward_all,(reward_all/cnt),call_time_sum,(call_time_sum / cnt)])
...
qoes = ['ar','al','hd','b']
networks = ['low','medium','high','fixed']
abr_name = 'Pensieve'
a = test("aaa",abr_name,qoes[3],networks[3])
print(a)
